...
两天前，作者发表了对Laravel最新的API资源功能的第一印象[原文地址](https://hackernoon.com/reusable-api-resource-with-nested-relationship-laravel-5-5-c654c7243869) && [译文地址](/laravel/api/first-impressions-on-laravel-api-resources.md)。
