import{_ as s,p as n,q as a,a1 as e}from"./framework-7e09d608.js";const c={},p=e(`<h1 id="如何在-centos-7-上新增-swap-分区" tabindex="-1"><a class="header-anchor" href="#如何在-centos-7-上新增-swap-分区" aria-hidden="true">#</a> 如何在 CentOS 7 上新增 swap 分区</h1><p>交换空间是磁盘上的唯一空间，当物理 RAM 已满时系统将使用该空间，当 Linux 机器耗尽 RAM 时，它使用交换空间从 RAM 中移动非活动页面。</p><p>要在 CentOS 7 操作系统上添加交换空间，可以使用以下两种方法，一种是为交换创建专用分区，另一种是创建交换文件并将其用作交换空间。</p><p>一般在云主机上可以通过创建交换文件并将其作为交换空间，用于机器在编译等重度需要内存的情况下使用。</p><h2 id="一些命令" tabindex="-1"><a class="header-anchor" href="#一些命令" aria-hidden="true">#</a> 一些命令</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查看SWAP信息是否正确</span>
