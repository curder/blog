import{_ as e,M as t,p as i,q as l,R as n,t as s,N as c,a1 as r}from"./framework-fb0bc66b.js";const o={},p=n("h1",{id:"安装和简单配置-nginx-proxy-manager",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#安装和简单配置-nginx-proxy-manager","aria-hidden":"true"},"#"),s(" 安装和简单配置 Nginx Proxy Manager")],-1),d=n("h2",{id:"前置条件",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#前置条件","aria-hidden":"true"},"#"),s(" 前置条件")],-1),u={href:"https://nginxproxymanager.com/",target:"_blank",rel:"noopener noreferrer"},m=r(`<h2 id="安装-nginx-proxy-manager" tabindex="-1"><a class="header-anchor" href="#安装-nginx-proxy-manager" aria-hidden="true">#</a> 安装 Nginx Proxy Manager</h2><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&quot;3&quot;</span>
