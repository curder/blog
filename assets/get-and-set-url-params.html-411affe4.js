import{_ as l,M as t,p as d,q as r,R as s,t as a,N as i,a1 as c}from"./framework-64ffeeb4.js";const o={},p={href:"https://github.com/openresty/lua-nginx-module#ngxreqget_uri_args",target:"_blank",rel:"noopener noreferrer"},v={href:"https://github.com/openresty/lua-nginx-module#ngxreqget_post_args",target:"_blank",rel:"noopener noreferrer"};function u(k,n){const e=t("ExternalLinkIcon");return d(),r("div",null,[n[7]||(n[7]=s("h1",{id:"获取和设置-uri-和请求主体的参数",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#获取和设置-uri-和请求主体的参数","aria-hidden":"true"},"#"),a(" 获取和设置 uri 和请求主体的参数")],-1)),n[8]||(n[8]=s("h2",{id:"获取请求-uri-和请求主体的参数",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#获取请求-uri-和请求主体的参数","aria-hidden":"true"},"#"),a(" 获取请求 uri 和请求主体的参数")],-1)),s("p",null,[n[2]||(n[2]=a("首先看一下官方 API 文档，获取一个 ",-1)),n[3]||(n[3]=s("code",null,"uri",-1)),n[4]||(n[4]=a(" 有两个方法：",-1)),s("a",p,[n[0]||(n[0]=a("ngx.req.get_uri_args",-1)),i(e)]),n[5]||(n[5]=a(" 、",-1)),s("a",v,[n[1]||(n[1]=a("ngx.req.get_post_args",-1)),i(e)]),n[6]||(n[6]=a("，二者主要的区别是参数来源有区别。",-1))]),n[9]||(n[9]=c(`<p>参考下面例子：</p><div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">server</span></span> <span class="token punctuation">{</span>
...
<span class="token comment">#[POST] key:b v:2</span>
<span class="token comment">#[POST] key:key v:value</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,14))])}const b=l(o,[["render",u],["__file","get-and-set-url-params.html.vue"]]);export{b as default};
