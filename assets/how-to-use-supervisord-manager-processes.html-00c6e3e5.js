import{_ as t,M as l,p as r,q as c,R as n,t as a,N as i,a1 as o}from"./framework-64ffeeb4.js";const p={},d={href:"http://supervisord.org/",target:"_blank",rel:"noopener noreferrer"},u={href:"https://blog.csdn.net/xyang81/article/details/51555473",target:"_blank",rel:"noopener noreferrer"};function v(m,s){const e=l("ExternalLinkIcon");return r(),c("div",null,[s[5]||(s[5]=n("h1",{id:"使用supervisord管理进程",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#使用supervisord管理进程","aria-hidden":"true"},"#"),a(" 使用supervisord管理进程")],-1)),n("p",null,[n("a",d,[s[0]||(s[0]=a("supervisord",-1)),i(e)]),s[1]||(s[1]=a("是一个进程管理工具，用来启动、停止、重启和监测进程，当程序挂掉后",-1)),s[2]||(s[2]=n("code",null,"supervisor",-1)),s[3]||(s[3]=a("能够重新启动进程。",-1))]),s[6]||(s[6]=o(`<blockquote><p><strong>注意：</strong> <code>Supervisor</code>只能<strong>管理非daemon的进程</strong>，也就是说<code>Supervisor</code>不能管理守护进程。否则提示<code>Exited too quickly (process log may have details)</code>异常。</p></blockquote><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><p>这里使用<code>yum</code>安装，<code>supervisor</code>没有发布在标准的CentOS源里，需要安装<code>epel</code>源。</p><ul><li><p>默认配置文件：<code>/etc/supervisord.conf</code></p></li><li><p>进程管理配置文件放到：<code>/etc/supervisord.d/</code></p></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>yum install -y epel-release supervisor
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote></li><li><p>修改文件权限</p></li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">chmod</span> <span class="token number">766</span> supervisord.service
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ol start="3"><li>设置开机启动</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>systemctl <span class="token builtin class-name">enable</span> supervisord.service
systemctl daemon-reload
systemctl start supervisord.service <span class="token comment"># 启动</span>
systemctl restart supervisord.service <span class="token comment"># 重启</span>
systemctl stop supervisord.service <span class="token comment"># 关闭</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="4"><li>验证是否开机自启动</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>systemctl is-enabled supervisord
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>其它Linux发行版开机启动脚本：https://github.com/Supervisor/initscripts</p><h2 id="参考地址" tabindex="-1"><a class="header-anchor" href="#参考地址" aria-hidden="true">#</a> 参考地址</h2>`,50)),n("ul",null,[n("li",null,[n("a",u,[s[4]||(s[4]=a("Supervisor安装与配置（Linux/Unix进程管理工具）",-1)),i(e)])])])])}const k=t(p,[["render",v],["__file","how-to-use-supervisord-manager-processes.html.vue"]]);export{k as default};
