import{_ as l,M as o,p,q as r,R as e,t as s,N as t,a1 as i}from"./framework-64ffeeb4.js";const d={},c={href:"https://openresty.org/cn/linux-packages.html",target:"_blank",rel:"noopener noreferrer"},u={href:"https://openresty.org/cn/download.html",target:"_blank",rel:"noopener noreferrer"},v={href:"https://openresty.org/download/openresty-1.21.4.1.tar.gz",target:"_blank",rel:"noopener noreferrer"};function m(b,n){const a=o("ExternalLinkIcon");return p(),r("div",null,[n[9]||(n[9]=e("h1",{id:"安装openresty",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#安装openresty","aria-hidden":"true"},"#"),s(" 安装OpenResty")],-1)),n[10]||(n[10]=e("h2",{id:"包管理安装",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#包管理安装","aria-hidden":"true"},"#"),s(" 包管理安装")],-1)),e("p",null,[n[1]||(n[1]=s("OpenResty 现在提供了 CentOS 上的 ",-1)),e("a",c,[n[0]||(n[0]=s("官方包",-1)),t(a)]),n[2]||(n[2]=s("。 只需运行下面的命令：",-1))]),n[11]||(n[11]=i(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># add the yum repo:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="源码包准备" tabindex="-1"><a class="header-anchor" href="#源码包准备" aria-hidden="true">#</a> 源码包准备</h2>`,2)),e("p",null,[n[4]||(n[4]=s("首先要在",-1)),e("a",u,[n[3]||(n[3]=s("官网下载",-1)),t(a)]),n[5]||(n[5]=s(" OpenResty 的源码包。",-1))]),e("p",null,[n[7]||(n[7]=s("官网上会提供很多的版本，各个版本有什么不同也会有说明，可以按需选择下载，这里下载 ",-1)),e("a",v,[n[6]||(n[6]=s("openresty-1.21.4.1.tar.gz",-1)),t(a)]),n[8]||(n[8]=s("。",-1))]),n[12]||(n[12]=i(`<h3 id="依赖库安装" tabindex="-1"><a class="header-anchor" href="#依赖库安装" aria-hidden="true">#</a> 依赖库安装</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> yum <span class="token function">install</span> <span class="token parameter variable">-y</span> readline-devel pcre-devel openssl-devel perl perl-devel perl-ExtUtils-Embed  libxml2 libxslt-devel gd-devel GeoIP GeoIP-devel google-perftools google-perftools-devel
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,15))])}const k=l(d,[["render",m],["__file","centos-7-install-openresty.html.vue"]]);export{k as default};
