import{_ as d,M as l,p as s,q as u,R as t,t as n,N as a,a1 as r}from"./framework-64ffeeb4.js";const v={},c={style:{"text-align":"center"}},g={href:"https://www.vagrantup.com/docs/networking/forwarded_ports.html",title:"vagrant端口转发文档地址",target:"_blank",rel:"noopener noreferrer"},m={style:{"text-align":"center"}},b={href:"https://www.vagrantup.com/docs/synced-folders/",title:"vagrant官网共享目录文档地址",target:"_blank",rel:"noopener noreferrer"},p=["src"];function f(o,e){const i=l("ExternalLinkIcon");return s(),u("div",null,[e[10]||(e[10]=t("h1",{id:"vagrant端口转发和文件共享",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#vagrant端口转发和文件共享","aria-hidden":"true"},"#"),n(" Vagrant端口转发和文件共享")],-1)),t("table",null,[e[9]||(e[9]=t("thead",null,[t("tr",null,[t("th",{style:{"text-align":"center"}},"操作"),t("th",{style:{"text-align":"left"}},"解释")])],-1)),t("tbody",null,[t("tr",null,[t("td",c,[e[1]||(e[1]=n("端口转发（",-1)),t("a",g,[e[0]||(e[0]=n("文档地址",-1)),a(i)]),e[2]||(e[2]=n("）",-1))]),e[3]||(e[3]=t("td",{style:{"text-align":"left"}},"将本机具体端口转发到指定虚拟机端口",-1))]),t("tr",null,[t("td",m,[e[5]||(e[5]=n("共享目录（",-1)),t("a",b,[e[4]||(e[4]=n("文档地址",-1)),a(i)]),e[6]||(e[6]=n("）",-1))]),e[7]||(e[7]=t("td",{style:{"text-align":"left"}},"将本机具体目录和虚拟机共享",-1))]),e[8]||(e[8]=t("tr",null,[t("td",{style:{"text-align":"center"}},"网络配置"),t("td",{style:{"text-align":"left"}},"公有网络、私有网络和Host Only三种网络配置方式")],-1))])]),e[11]||(e[11]=r(`<h4 id="端口转发" tabindex="-1"><a class="header-anchor" href="#端口转发" aria-hidden="true">#</a> 端口转发</h4><p>将下面的代码段写入到vagrant的Vagrantfile配置文件中。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>config.vm.network &quot;forwarded_port&quot;, guest: 80, host: 8888
config.vm.network &quot;forwarded_port&quot;, guest: 8888, host: 8889
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>将虚拟机的 <code>80</code> 端口映射到本地机的 <code>8888</code> 端口以及虚拟机的 <code>8888</code> 端口映射到本地机的 <code>8889</code> 端口，使用<code>vagrant reload</code>重启虚拟机生效。 **注意：**这里所说的虚拟机为vagrant虚拟机，本地机为Mac开发机。</p></blockquote><p>我们来到 VirtualBox 中可以在虚拟机的 “设置” =&gt; &quot;网络&quot; =&gt; &quot;高级&quot; =&gt; &quot;端口转发&quot;</p>`,5)),t("img",{src:o.$withBase("/images/tools/vagrant/forwarded_ports.png"),alt:""},null,8,p),e[12]||(e[12]=r(`<h4 id="共享目录" tabindex="-1"><a class="header-anchor" href="#共享目录" aria-hidden="true">#</a> 共享目录</h4><p>将下面的代码段写入到vagrant的Vagrantfile配置文件中。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>config.vm.synced_folder &quot;/Users/curder/website&quot;, &quot;/var/www/html&quot;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,14))])}const h=d(v,[["render",f],["__file","vagrant-port-forwarding-and-file-sharing.html.vue"]]);export{h as default};
