import{_ as i,M as l,p as o,q as p,R as s,t as n,N as a,a1 as t}from"./framework-fb0bc66b.js";const c={},r=s("h1",{id:"安装openresty",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#安装openresty","aria-hidden":"true"},"#"),n(" 安装OpenResty")],-1),d=s("h2",{id:"包管理安装",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#包管理安装","aria-hidden":"true"},"#"),n(" 包管理安装")],-1),u={href:"https://openresty.org/cn/linux-packages.html",target:"_blank",rel:"noopener noreferrer"},v=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># add the yum repo:</span>
