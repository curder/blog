import{_ as t,M as i,p as l,q as r,R as s,t as a,N as o,a1 as p}from"./framework-64ffeeb4.js";const c={},d={href:"https://nginxproxymanager.com/",target:"_blank",rel:"noopener noreferrer"};function u(m,n){const e=i("ExternalLinkIcon");return l(),r("div",null,[n[3]||(n[3]=s("h1",{id:"安装和简单配置-nginx-proxy-manager",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#安装和简单配置-nginx-proxy-manager","aria-hidden":"true"},"#"),a(" 安装和简单配置 Nginx Proxy Manager")],-1)),n[4]||(n[4]=s("h2",{id:"前置条件",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#前置条件","aria-hidden":"true"},"#"),a(" 前置条件")],-1)),s("p",null,[n[1]||(n[1]=a("安装 ",-1)),s("a",d,[n[0]||(n[0]=a("Nginx Proxy Manager",-1)),o(e)]),n[2]||(n[2]=a(" 时，需要先安装好 Nginx。",-1))]),n[5]||(n[5]=p(`<h2 id="安装-nginx-proxy-manager" tabindex="-1"><a class="header-anchor" href="#安装-nginx-proxy-manager" aria-hidden="true">#</a> 安装 Nginx Proxy Manager</h2><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&quot;3&quot;</span>
...
Password: changeme
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,6))])}const k=t(c,[["render",u],["__file","centos-7-install-nginx-proxy-manager.html.vue"]]);export{k as default};
