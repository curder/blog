import{_ as e,M as t,p,q as i,R as n,t as s,N as l,a1 as o}from"./framework-fb0bc66b.js";const c={},r=o(`<h1 id="让valet支持thinkphp3" tabindex="-1"><a class="header-anchor" href="#让valet支持thinkphp3" aria-hidden="true">#</a> 让Valet支持ThinkPHP3</h1><p>主要通过配置文件重写配置获得ThinkPHP3的支持，配置文件放置在<code>~/.valet/Drivers/</code>下，针对ThinkPHP3我们可以使用如下配置文件，文件名命名为<code>ThinkPHP3ValetDriver.php</code>：</p><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
