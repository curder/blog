import{_ as i,M as l,p as c,q as t,R as s,t as n,N as e,a1 as d}from"./framework-7e09d608.js";const r={},o=s("h1",{id:"获取和设置-uri-和请求主体的参数",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#获取和设置-uri-和请求主体的参数","aria-hidden":"true"},"#"),n(" 获取和设置 uri 和请求主体的参数")],-1),p=s("h2",{id:"获取请求-uri-和请求主体的参数",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#获取请求-uri-和请求主体的参数","aria-hidden":"true"},"#"),n(" 获取请求 uri 和请求主体的参数")],-1),v=s("code",null,"uri",-1),u={href:"https://github.com/openresty/lua-nginx-module#ngxreqget_uri_args",target:"_blank",rel:"noopener noreferrer"},k={href:"https://github.com/openresty/lua-nginx-module#ngxreqget_post_args",target:"_blank",rel:"noopener noreferrer"},m=d(`<p>参考下面例子：</p><div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">server</span></span> <span class="token punctuation">{</span>
