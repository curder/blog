import{_ as e,M as i,p as t,q as l,R as n,t as s,N as c,a1 as p}from"./framework-96b046e1.js";const o={},r=n("h1",{id:"获取请求头",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#获取请求头","aria-hidden":"true"},"#"),s(" 获取请求头")],-1),d={href:"https://github.com/openresty/lua-nginx-module#ngxreqget_headers",target:"_blank",rel:"noopener noreferrer"},v=n("code",null,"ngx.req.get_headers()",-1),u=p(`<div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">worker_processes</span>  <span class="token number">1</span></span><span class="token punctuation">;</span>        <span class="token comment">#nginx worker 数量</span>
