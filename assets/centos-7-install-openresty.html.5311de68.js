import{_ as i,r as l,o,c as p,b as s,a,F as c,d as n,e as t}from"./app.a391f414.js";const d={},r=s("h1",{id:"\u5B89\u88C5openresty",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#\u5B89\u88C5openresty","aria-hidden":"true"},"#"),n(" \u5B89\u88C5OpenResty")],-1),u=s("h2",{id:"\u5305\u7BA1\u7406\u5B89\u88C5",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#\u5305\u7BA1\u7406\u5B89\u88C5","aria-hidden":"true"},"#"),n(" \u5305\u7BA1\u7406\u5B89\u88C5")],-1),v=n("OpenResty \u73B0\u5728\u63D0\u4F9B\u4E86 CentOS \u4E0A\u7684 "),m={href:"https://openresty.org/cn/linux-packages.html",target:"_blank",rel:"noopener noreferrer"},h=n("\u5B98\u65B9\u5305"),b=n("\u3002 \u53EA\u9700\u8FD0\u884C\u4E0B\u9762\u7684\u547D\u4EE4\uFF1A"),k=t(`<div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment"># add the yum repo:</span>
...
<span class="token function">sudo</span> yum <span class="token function">install</span> -y openresty openresty-resty
...
./configure --prefix<span class="token operator">=</span>/usr/local/openresty <span class="token punctuation">\\</span>
