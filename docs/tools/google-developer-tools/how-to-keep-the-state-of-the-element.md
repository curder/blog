...
![](./images/google-developer-tools/keep-the-state-of-the-element-hover.png)

保持元素状态的目的可能是获取特殊状态下元素的属性。

众所周知，元素的状态多种多样，通过上面的方式我们可以看到有五种，其实也可以通过一个面板进行多选，它在面板右侧的`Styles`里面（默认是隐藏的，需要我们点击打开它）。

![](./images/google-developer-tools/keep-the-state-of-the-element-switch-many-states.png)
