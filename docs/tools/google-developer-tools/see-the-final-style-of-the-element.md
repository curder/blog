...
![](./images/google-developer-tools/see-the-final-style-of-the-element-unuse-panel.png)

一些开发情况下需要直接获取所选元素当时生效的样式，此时可以来到`Computed`计算性属性的面板。

![](./images/google-developer-tools/see-the-final-style-of-the-element-computed-styles.png)
...
![](./images/google-developer-tools/see-the-final-style-of-the-element-fast-go-to-styles-panel.png)
