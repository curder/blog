...
![](./images/how-to-be-free-on-all-major-platforms-over-the-fire-wall/use-free-ss-number.png)
...
![](./images/how-to-be-free-on-all-major-platforms-over-the-fire-wall/shadowsocks-macos-ui.png)

上面的配置都完毕了，就可以畅游Google和YouTube了。

![](./images/how-to-be-free-on-all-major-platforms-over-the-fire-wall/hello-google.png)
...
![](./images/how-to-be-free-on-all-major-platforms-over-the-fire-wall/shadowsocks-windows-ui.png)
...
![](./images/how-to-be-free-on-all-major-platforms-over-the-fire-wall/use-open-wingy-ui.jpeg)
