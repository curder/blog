...
* [安装Package Control包管理](/tools/sublime/install-and-using-package-control-package-management.md)
* [安装sublime编辑器和主题以及编辑器配置](/tools/sublime/install-sublime-editor-and-theme-and-editor-configuration.md)
